...
return (new CustomEvent(event_name,(function (){var obj35125 = ({"detail":data});
return obj35125;
})()));
} else {
...
var f = (function (){var pred__35132 = cljs.core._EQ_;
var expr__35133 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__35132.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__35133))){
return (function (p1__35126_SHARP_){
return console.warn(p1__35126_SHARP_);
});
} else {
if(cljs.core.truth_(pred__35132.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__35133))){
return (function (p1__35127_SHARP_){
return console.debug(p1__35127_SHARP_);
});
} else {
if(cljs.core.truth_(pred__35132.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__35133))){
return (function (p1__35128_SHARP_){
return console.error(p1__35128_SHARP_);
});
} else {
return (function (p1__35129_SHARP_){
return console.log(p1__35129_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__35136){
...
var opts = map__35137__$1;
var eval_fn = cljs.core.get.call(null,map__35137__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__35139_SHARP_){
return new_def.callback(p1__35139_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__35140){
var vec__35141 = p__35140;
var ky = cljs.core.nth.call(null,vec__35141,(0),null);
...
}catch (e35146){if((e35146 instanceof Error)){
var e = e35146;
return not_found;
} else {
throw e35146;
...
//# sourceMappingURL=utils.js.map?rel=1663010192321
