...
var G__22445 = o;
goog.object.set(G__22445,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__22447__i < G__22447__a.length) {G__22447__a[G__22447__i] = arguments[G__22447__i + 0]; ++G__22447__i;}
  args = new cljs.core.IndexedSeq(G__22447__a,0,null);
} 
...
var G__22449 = o;
goog.object.set(G__22449,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__22450__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__22451__i < G__22451__a.length) {G__22451__a[G__22451__i] = arguments[G__22451__i + 0]; ++G__22451__i;}
  args = new cljs.core.IndexedSeq(G__22451__a,0,null);
} 
...
var G__22453 = props;
var G__22453__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__22453,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22453);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__22453__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__22454 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__22454,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__22454;
}
})(),id_class);
...
var G__22455 = (cljs.core.count.call(null,argv) - first_child);
switch (G__22455) {
case (0):
...
var vec__22457 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__22457,(0),null);
var id = cljs.core.nth.call(null,vec__22457,(1),null);
var className = cljs.core.nth.call(null,vec__22457,(2),null);
...
var temp__5724__auto___22460 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5724__auto___22460 == null)){
} else {
var key_22461 = temp__5724__auto___22460;
(jsprops.key = key_22461);
}
...
var temp__5724__auto___22462 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5724__auto___22462 == null)){
} else {
var key_22463 = temp__5724__auto___22462;
(jsprops.key = key_22463);
}
...
var temp__5724__auto___22464 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5724__auto___22464 == null)){
} else {
var key_22465 = temp__5724__auto___22464;
(jsprops.key = key_22465);
}
...
var temp__5724__auto___22466 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5724__auto___22466 == null)){
} else {
var key_22467 = temp__5724__auto___22466;
(jsprops.key = key_22467);
}
...
var temp__5724__auto___22468 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5724__auto___22468 == null)){
} else {
var key_22469 = temp__5724__auto___22468;
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__22470_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__22470_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22471 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__22471,(0),null);
var derefed = cljs.core.nth.call(null,vec__22471,(1),null);
...
break;
default:
var G__22476 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template22481 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template22481 = (function (opts,id,fn_to_element,parse_fn,meta22482){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22481.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22483,meta22482__$1){
var self__ = this;
var _22483__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22481(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22482__$1));
}));

(reagent.impl.template.t_reagent$impl$template22481.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22483){
var self__ = this;
var _22483__$1 = this;
return self__.meta22482;
}));

(reagent.impl.template.t_reagent$impl$template22481.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22481.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22481.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template22481.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22481.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22481.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22482","meta22482",1398051725,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22481.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22481.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22481");

(reagent.impl.template.t_reagent$impl$template22481.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write.call(null,writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template22481");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22481.
 */
reagent.impl.template.__GT_t_reagent$impl$template22481 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template22481(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta22482){
return (new reagent.impl.template.t_reagent$impl$template22481(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta22482));
});

}

return (new reagent.impl.template.t_reagent$impl$template22481(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=template.js.map?rel=1661828486707
