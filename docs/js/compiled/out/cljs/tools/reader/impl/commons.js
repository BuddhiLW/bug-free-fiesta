...
var G__29205 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__29205;
continue;
} else {
return ch;
...
var vec__29206 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__29206,(0),null);
return (match === s);
});
...
var len__4736__auto___29211 = arguments.length;
var i__4737__auto___29212 = (0);
while(true){
if((i__4737__auto___29212 < len__4736__auto___29211)){
args__4742__auto__.push((arguments[i__4737__auto___29212]));

var G__29213 = (i__4737__auto___29212 + (1));
i__4737__auto___29212 = G__29213;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq29209){
...
return (function() { 
var G__29214__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__29214 = function (rdr,var_args){
var _ = null;
...
while (G__29215__i < G__29215__a.length) {G__29215__a[G__29215__i] = arguments[G__29215__i + 1]; ++G__29215__i;}
  _ = new cljs.core.IndexedSeq(G__29215__a,0,null);
} 
return G__29214__delegate.call(this,rdr,_);};
G__29214.cljs$lang$maxFixedArity = 1;
G__29214.cljs$lang$applyTo = (function (arglist__29216){
var rdr = cljs.core.first(arglist__29216);
var _ = cljs.core.rest(arglist__29216);
return G__29214__delegate(rdr,_);
});
...
//# sourceMappingURL=commons.js.map?rel=1663010185420
